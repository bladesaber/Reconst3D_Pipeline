...
# grid = o3d.geometry.VoxelGrid.create_from_point_cloud(input=pcd, voxel_size=2.0)
#
# mesh, _ = o3d.geometry.TriangleMesh.create_from_point_cloud_alpha_shape(grid, 3.0)
#
